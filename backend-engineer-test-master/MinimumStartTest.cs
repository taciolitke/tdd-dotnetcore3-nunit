...
namespace BackendEngineer
{
    ...
    {
        private IMinimumStartService _minimumStartService;

        [SetUp]
        public void Setup()
        {
            _minimumStartService = new MinimumStartService();
        }
        ...
        public void MinimumStart_Sample1()
        {
            ...
            var output = _minimumStartService.MinimumStart(input);
        ...
        [Test]
        public void MinimumStart_InvalidOperationException()
        {
            Assert.Throws<InvalidOperationException>(() => _minimumStartService.MinimumStart(null));
        }
    }
}